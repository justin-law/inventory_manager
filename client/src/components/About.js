        ...
        <div className="create-content">
            <div className='create-card'>
                <h3>About The App</h3>
                    ...
                    <p>I created this app to learn about the MERN stack and for one of the student groups that I am involved in.
                    ...
                    <p>This was my first large project working with the tools and frameworks of the MERN stack and I learned a lot about modern website building.
                        The source code is available on my GitHub repo</p>
